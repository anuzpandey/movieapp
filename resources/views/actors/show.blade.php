...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="flex-none">
                ...
                <!-- Image Here-->
                <img src="{{ $actor['profile_path'] }}" alt=" Poster" class="w-custom-20">
                <ul class="flex items-center mt-4">
                    ...
                    @if ($actor['homepage'])
                        <li class="ml-6">
                            <a href="{{ $actor['homepage'] }}" title="{{ $actor['name'] }} Website" target="_blank">
    ...
    <!-- Credits Section Here -->
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-8">
            <h4 class="text-4xl font-semibold">Credits</h4>
            <ul class="list-disc leading-loose pl-5 mt-8">
                @foreach ($credits as $credit)
                    <li>
                        {{ $credit['release_year'] }} &middot;
                        <strong>{{ $credit['title'] }}<a href="" class="hover:underline"></a></strong>
                        as {{ $credit['character'] }}
                    </li>
                @endforeach

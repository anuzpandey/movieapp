...
@section('content')
    ...
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <!-- Image Here-->
            <img src="{{ $tvShow['poster_path'] }}" alt="{{ $tvShow['name'] }} Poster" class="w-custom-20 rounded-lg">
                    ...
                    @if(count($tvShow['videos']['results']) > 0)
                        ...
                        <div class="mt-12">
                            <button
                                ...
                                class="flex items-center inline-flex bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150"
                                @click="isOpen = true"
                            >
                            ...
                            <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                                <div class="bg-transparent rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative rounded-lg" style="padding-top: 56.25%">
                                            <iframe
                ...
                @foreach($tvShow['cast'] as $cast)
                    <div class="mt-4">
                        <a href="{{ route('actors.show', $cast['id']) }}">
                            <img src="{{ $cast['profile_path'] }}" alt="{{ $tvShow['name'] }} Images" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="mt-2">
    ...
    <div class="tv-images border-b border-gray-800" x-data="{ isOpen: false, image: '' }">
        <div class="container mx-auto px-4 py-8">
            <h4 class="text-4xl font-semibold">Images</h4>
                ...
                @foreach($tvShow['images'] as $image)
                    <div class="mt-4">
                        <a href="#" @click.prevent="isOpen = true, image = '{{ 'https://image.tmdb.org/t/p/original/'.$image['file_path'] }}'">
                            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path'] }}" alt="Katherine Langford" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>
                @endforeach
            ...
            >
                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-transparent rounded">
                        ...
                        <div class="modal-body px-8 py-8">
                            <img :src="image" alt="Poster" class="rounded-lg">
                        </div>
                    </div>
                </div>
            </div>
